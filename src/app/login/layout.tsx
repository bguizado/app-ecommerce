...
const AlipayIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-alipay" viewBox="0 0 16 16">
...
const PaypalIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-paypal" viewBox="0 0 16 16">
...
const StripeIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-stripe" viewBox="0 0 16 16">
...
export default function Layout({
  ...
  return (
    ...
    <body className={inter.className}>
      <HeaderSinBusqueda></HeaderSinBusqueda>
        {children}
